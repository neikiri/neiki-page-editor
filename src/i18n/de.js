/**
 * German translation map for Neiki's Page Editor.
...
export const de = {
  ...
  'toolbar.insertDropdown': 'Einfügen',
  ...
  'menu.more.clearAll': 'Alles löschen',
  'menu.more.changeTheme': 'Design ändern',
  'menu.more.fullscreen': 'Vollbild',
  'menu.more.help': 'Hilfe',

  // Modals — common actions
  'modal.common.insert': 'Einfügen',
  'modal.common.cancel': 'Abbrechen',
  'modal.common.apply': 'Übernehmen',
  'modal.common.close': 'Schließen',

  // Modals — Link
  'modal.link.title': 'Link einfügen',
  'modal.link.url': 'URL',
  'modal.link.text': 'Anzeigetext',
  'modal.link.newTab': 'In neuem Tab öffnen',
  'modal.link.insert': 'Einfügen',
  'modal.link.cancel': 'Abbrechen',

  // Modals — Image
  'modal.image.title': 'Bild einfügen',
  ...
  'modal.image.uploadHintHandler': 'Wird über den konfigurierten Handler hochgeladen',
  ...
  'modal.image.upload': 'Dateien auswählen oder hierher ziehen',
  'modal.image.dropzone': 'Bilder hier ablegen oder klicken zum Durchsuchen',
  'modal.image.insert': 'Einfügen',
  'modal.image.cancel': 'Abbrechen',

  // Modals — Video
  'modal.video.title': 'Video einfügen',
  ...
  'modal.video.upload': 'Datei auswählen',
  'modal.video.insert': 'Einfügen',
  'modal.video.cancel': 'Abbrechen',

  // Modals — Table
  'modal.table.title': 'Tabelle einfügen',
  'modal.table.rows': 'Zeilen',
  'modal.table.cols': 'Spalten',
  'modal.table.columns': 'Spalten',
  'modal.table.headerRow': 'Kopfzeile einschließen',
  'modal.table.insert': 'Einfügen',
  'modal.table.cancel': 'Abbrechen',

  // Modals — Emoji / Special chars
  'modal.emoji.title': 'Emoji einfügen',
  'modal.specialChars.title': 'Sonderzeichen',

  // Context menu — table
  'contextMenu.table.insertRowAbove': 'Zeile oberhalb einfügen',
  'contextMenu.table.insertRowBelow': 'Zeile unterhalb einfügen',
  'contextMenu.table.insertColLeft': 'Spalte links einfügen',
  'contextMenu.table.insertColRight': 'Spalte rechts einfügen',
  'contextMenu.table.deleteRow': 'Zeile löschen',
  'contextMenu.table.deleteCol': 'Spalte löschen',
  'contextMenu.table.deleteTable': 'Tabelle löschen',
  ...
  'modal.findReplace.caseSensitive': 'Groß-/Kleinschreibung beachten',
  'modal.findReplace.useRegex': 'Regulärer Ausdruck',
  'modal.findReplace.findNext': 'Weitersuchen',
  'modal.findReplace.replaceOne': 'Ersetzen',
  'modal.findReplace.replaceAll': 'Alle ersetzen',
  'modal.findReplace.close': 'Schließen',

  // Color picker
  'color.apply': 'Übernehmen',
  'color.reset': 'Zurücksetzen',
  'color.hex': 'Hex',

  // Status bar
  'statusbar.words': 'Wörter',
  ...
  // Table context menu
  'table.insertRowAbove': 'Zeile oberhalb einfügen',
  'table.insertRowBelow': 'Zeile unterhalb einfügen',
  'table.insertColLeft': 'Spalte links einfügen',
  'table.insertColRight': 'Spalte rechts einfügen',
  ...
  // Confirm messages
  'confirm.clearAll': 'Möchtest du wirklich den gesamten Inhalt löschen?',

  // Error / status messages
  'error.saveFailed': 'Speichern fehlgeschlagen. Deine Änderungen bleiben erhalten.',
  ...
  'overlay.media.delete':     'Löschen',

  // Floating toolbar
  'floatingToolbar.label':         'Auswahl-Werkzeugleiste',
  'floatingToolbar.link':          'Link einfügen',
