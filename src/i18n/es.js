/**
 * Spanish translation map for Neiki's Page Editor.
 * Keys use flat dot-separated style compatible with Neiki's Editor.
 */
export const es = {
  // Toolbar buttons
  'toolbar.viewCode': 'Ver código fuente',
  ...
  'toolbar.fontSize': 'Tamaño de letra',
  ...
  'menu.more.autosave': 'Guardado automático',
  ...
  'modal.link.newTab': 'Abrir en una pestaña nueva',
  ...
  'modal.image.uploadHintHandler': 'Se subirá mediante el gestor configurado',
  'modal.image.uploadHintBase64': 'Se convertirá a base64',
  ...
  'modal.image.upload': 'Elige archivos o arrástralos aquí',
  'modal.image.dropzone': 'Suelta las imágenes aquí o haz clic para explorar',
  'modal.image.insert': 'Insertar',
  'modal.image.cancel': 'Cancelar',

  // Modals — Video
  'modal.video.title': 'Insertar vídeo',
  'modal.video.urlTab': 'URL',
  'modal.video.uploadTab': 'Subir',
  'modal.video.tabUrl': 'URL',
  'modal.video.tabUpload': 'Subir',
  'modal.video.url': 'URL del vídeo',
  ...
  // Modals — Source View
  'modal.source.title': 'Ver código fuente',
  ...
  'modal.findReplace.caseSensitive': 'Distinguir mayúsculas y minúsculas',
  'modal.findReplace.useRegex': 'Expresión regular',
  ...
  'statusbar.autosave': 'Guardado automático',
  ...
  // Confirm messages
  'confirm.clearAll': '¿Seguro que quieres borrar todo el contenido?',
  ...
  'error.dataUrisDisabled': 'La incrustación de archivos está desactivada. Proporciona una URL o configura un gestor de subida.',
  ...
  // Floating toolbar
  'floatingToolbar.label':         'Barra de herramientas de selección',
